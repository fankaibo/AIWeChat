...
> 本项目仅供学习与技术交流使用。请勿传播使用本项目接触到的真实聊天数据、数据库、密钥、解密快照或其他敏感信息。请仅处理本人拥有且有权访问的数据，并自行承担因配置、运行或使用不当可能造成的数据泄露、数据损坏、账号或设备异常等风险。欢迎通过 [Issue](https://github.com/fankaibo/AIWeChat/issues) 或 Pull Request 提出建议。
...
开发与持续维护不易。如果这个项目对你有所帮助，欢迎使用微信扫码支持。每一份鼓励都会成为继续改进项目的动力，感谢你的认可与支持！

<p align="center">
  <img src="public/wechat-donation.jpg" alt="微信赞赏码" width="360">
</p>
